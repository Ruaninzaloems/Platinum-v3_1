...
- EMS role / module-access provisioning was **not** ported (matches the recommended
  option in the source doc): new Azure users get the default role until assigned.
