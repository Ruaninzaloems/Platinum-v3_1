...
BEGIN
    CREATE TABLE Payroll_OvertimeTransaction (
        ...
        IsExcessApproved                bit               NOT NULL DEFAULT 0,
        IsPayrollCaptured               bit               NOT NULL DEFAULT 0,
        ...
        RecommenderChainPositionId      nvarchar(64)      NULL,
        RecommenderChainPositionName    nvarchar(500)     NULL,
        ApproverEmployeeId              nvarchar(64)      NULL,
        ApproverEmployeeName            nvarchar(300)     NULL,
        ApproverChainPositionId         nvarchar(64)      NULL,
        ApproverChainPositionName       nvarchar(500)     NULL,
        ...
        LegacyDepartmentId              int               NULL,
        LegacyDepartmentName            nvarchar(500)     NULL,
        LegacyDivisionId                int               NULL,
        LegacyDivisionName              nvarchar(500)     NULL,
        CreatedAt                       datetime2         NOT NULL,
        UpdatedAt                       datetime2         NOT NULL,
