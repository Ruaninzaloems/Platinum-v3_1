    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AllowOvertimeMultipleApproval = table.Column<bool>(type: "bit", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CountingPeriodStartDay = table.Column<int>(type: "int", nullable: false),
                    CountingPeriodEndDay = table.Column<int>(type: "int", nullable: false),
                    MaximumMonthlyOvertimeHours = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    ExceptionalMaximumOvertimeHours = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    SingletonLock = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false, defaultValue: "X")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOvertimeRecommender = table.Column<bool>(type: "bit", nullable: false),
                    IsOvertimeApprover = table.Column<bool>(type: "bit", nullable: false),
                    IsDepartmentExcessOvertimeApprover = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OvertimeTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OvertimeTransactionDocument_OvertimeTransaction_OvertimeTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OvertimeWorkflowState_OvertimeTransaction_OvertimeTransactionId",
                        column: x => x.OvertimeTransactionId,
                        principalTable: "OvertimeTransaction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PositionApprovalConfigId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReportsToPositionId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ReportsToPositionDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PositionReportingRelationship_PositionApprovalConfig_PositionApprovalConfigId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PositionApprovalConfigId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActingEmployeeId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ActingEmployeeName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ActingInPositionId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ActingInPositionDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TemporaryActingAppointment_PositionApprovalConfig_PositionApprovalConfigId",
                        column: x => x.PositionApprovalConfigId,
                        principalTable: "PositionApprovalConfig",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
