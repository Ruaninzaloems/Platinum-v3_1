...
public class OvertimeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<PayrollPosition>(e =>
        {
            ...
            e.Property(x => x.EmployeeId).HasColumnName("EmployeeID").HasMaxLength(64);
        ...
        b.Entity<ConstMOC>(e =>
        {
            ...
            e.Property(x => x.Enabled).HasColumnName("Enabled");
            e.Property(x => x.StartDate).HasColumnName("StartDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.EndDate).HasColumnName("EndDate").HasColumnType("decimal(18,8)");
        });
        ...
        b.Entity<AAAAConfigSettings>(e =>
        {
            ...
            e.Property(x => x.DateCaptured).HasColumnName("DateCaptured").HasColumnType("decimal(18,8)");
        ...
        b.Entity<ConstCycle>(e =>
        {
            ...
            e.Property(x => x.DateCaptured).HasColumnName("DateCaptured").HasColumnType("decimal(18,8)");
            e.Property(x => x.CapturerId).HasColumnName("CapturerID");
            e.Property(x => x.DateModified).HasColumnName("DateModified").HasColumnType("decimal(18,8)");
        ...
        b.Entity<ConstDepartment>(e =>
        {
            ...
            e.Property(x => x.StartDate).HasColumnName("StartDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.EndDate).HasColumnName("EndDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.VatApportionment).HasColumnName("VatApportionment").HasColumnType("decimal(18,4)");
            e.Property(x => x.ManagerPositionId).HasColumnName("ManagerPositionID");
            e.Property(x => x.ManagerStartDate).HasColumnName("ManagerStartDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.ManagerEndDate).HasColumnName("ManagerEndDate").HasColumnType("decimal(18,8)");
        ...
        b.Entity<PayrollCyclePeriodDetails>(e =>
        {
            ...
            e.Property(x => x.PeriodStartDate).HasColumnName("PeriodStartDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.PeriodEndDate).HasColumnName("PeriodEndDate").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.ModifierId).HasColumnName("ModifierID");
            e.Property(x => x.CycleId).HasColumnName("CycleID");
            e.Property(x => x.ProcessedDate).HasColumnName("ProcessedDate").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.LockDownDate).HasColumnName("LockDownDate").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.ApprovedDate).HasColumnName("ApprovedDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.ApprovedBy).HasColumnName("ApprovedBy");
            e.Property(x => x.FinalRunDate).HasColumnName("FinalRunDate").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.LockDownCancelledDate).HasColumnName("LockDownCancelledDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.ApprovedStatus).HasColumnName("ApprovedStatus");
            e.Property(x => x.TrialRunDate).HasColumnName("TrialRunDate").HasColumnType("decimal(18,8)");
        ...
        b.Entity<UserUserDetail>(e =>
        {
            ...
            e.Property(x => x.LastLoginDate).HasColumnName("LastLoginDate").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.PasswordLastChangedDate).HasColumnName("PasswordLastChangedDate").HasColumnType("decimal(18,8)");
            e.Property(x => x.ModifierId).HasColumnName("ModifierID");
            e.Property(x => x.DateModified).HasColumnName("DateModified").HasColumnType("decimal(18,8)");
            ...
            e.Property(x => x.SignatureUploadedOn).HasColumnName("SignatureUploadedOn").HasColumnType("decimal(18,8)");
