...
const ICONS: Record<string, string> = {
  ...
  'trash': '<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6m5-4h4a1 1 0 011 1v1H9V3a1 1 0 011-1z"/>',
  ...
  'building': '<rect x="4" y="2" width="16" height="20" rx="2"/><line x1="9" y1="22" x2="9" y2="18"/><line x1="15" y1="22" x2="15" y2="18"/><rect x="8" y="6" width="3" height="3"/><rect x="13" y="6" width="3" height="3"/><rect x="8" y="12" width="3" height="3"/><rect x="13" y="12" width="3" height="3"/>',
  'dollar': '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>',
  'file': '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/>',
  'arrowRight': '<line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>',
  'arrowLeft': '<line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/>',
  'lightbulb': '<path d="M12 2a4 4 0 00-4 4c0 2 2 3 2 6h4c0-3 2-4 2-6a4 4 0 00-4-4z"/><line x1="10" y1="16" x2="14" y2="16"/><line x1="10" y1="19" x2="14" y2="19"/><path d="M10 22h4"/>',
...
@Component({
  selector: 'app-icon',
  standalone: true,
  template: `<span [innerHTML]="svgContent" [style.display]="'inline-flex'" [style.align-items]="'center'"></span>`
})
export class IconComponent {
  ...
  ngOnChanges(): void {
    ...
    const svg = `<svg viewBox="0 0 24 24" width="${this.size}" height="${this.size}" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${paths}</svg>`;
