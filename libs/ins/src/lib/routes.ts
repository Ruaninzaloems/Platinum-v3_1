...
// All Performance routes render the embedded perf-app iframe (perf-app is a
// standalone Angular app, not React — see Insight-Performance-Hub/artifacts/perf-app).
...
// navigation while perf-app provides every page.
