import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-statuses',
    standalone: true,
    imports: [CommonModule, MatCardModule, MatIconModule, MatButtonModule, MatProgressSpinnerModule],
    template: `
      <div class="page">
        <div class="page-header">
          <mat-icon class="page-icon">flag</mat-icon>
          <div><h2>Progress Statuses</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
