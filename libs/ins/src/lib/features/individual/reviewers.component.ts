    ...
    template: `
      <div class="page">
        <div class="page-header">
          ...
          <div><h2>Reviewer Configuration</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
          ...
          <mat-card><mat-card-content>
            <div class="center-content">
              <mat-icon class="big-icon">group</mat-icon>
              <h3>Reviewer Configuration</h3>
