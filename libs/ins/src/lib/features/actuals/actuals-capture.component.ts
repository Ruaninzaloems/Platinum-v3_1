import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-actuals-capture',
    standalone: true,
    imports: [CommonModule, MatCardModule, MatIconModule, MatButtonModule, MatProgressSpinnerModule],
    template: `
      <div class="page">
        <div class="page-header">
          <mat-icon class="page-icon">upload</mat-icon>
          <div><h2>Submit Actuals</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
  ...
  export class ActualsCaptureComponent implements OnInit {
