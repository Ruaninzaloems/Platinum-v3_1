import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-review-pms-manager',
    standalone: true,
    ...
    template: `
      <div class="page">
        <div class="page-header">
          ...
          <div><h2>Review — PMS Manager</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
          ...
          <mat-card><mat-card-content>
            <div class="center-content">
              <mat-icon class="big-icon">manage_accounts</mat-icon>
              <h3>Review — PMS Manager</h3>
  ...
  export class ReviewPmsManagerComponent implements OnInit {
