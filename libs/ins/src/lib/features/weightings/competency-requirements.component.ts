import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-competency-requirements',
    standalone: true,
    imports: [CommonModule, MatCardModule, MatIconModule, MatButtonModule, MatProgressSpinnerModule],
    template: `
      <div class="page">
        <div class="page-header">
          <mat-icon class="page-icon">tune</mat-icon>
          <div><h2>Competency Requirements</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
          ...
          <mat-card><mat-card-content>
            <div class="center-content">
              <mat-icon class="big-icon">tune</mat-icon>
