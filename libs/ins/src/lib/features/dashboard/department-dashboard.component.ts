import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-department-dashboard',
    standalone: true,
    ...
    template: `
      <div class="page">
        <div class="page-header">
          ...
          <div><h2>Department Dashboard</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
          ...
          <mat-card><mat-card-content>
            <div class="center-content">
              <mat-icon class="big-icon">business</mat-icon>
