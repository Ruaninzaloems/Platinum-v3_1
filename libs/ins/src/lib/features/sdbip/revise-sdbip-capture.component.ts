import { Component, signal, OnInit, inject } from '@angular/core';
  ...
  @Component({
    selector: 'app-ins-revise-sdbip-capture',
    standalone: true,
    ...
    template: `
      <div class="page">
        <div class="page-header">
          ...
          <div><h2>Revise SDBIP — Capture</h2><p class="sub">Performance Management System</p></div>
        </div>
        @if (loading()) {
