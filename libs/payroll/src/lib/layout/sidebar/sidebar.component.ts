...
export class SidebarComponent {
  collapsed$;
  expandedGroups: Record<string, boolean> = { 'hr': true, 'payroll': false, 'timeManagement': false, 'leave': false, 'config': true, 'company': false, 'hrStructure': false, 'payrollSetup': false, 'benefits': false, 'payStructure': false, 'other': false, 'payrollTransactions': false, 'timeConfig': false, 'leaveConfig': false, 'timeAttendance': false };
  ...
  navItems: NavItem[] = [
    ...
    {
      label: 'My Approvals', route: '/approvals',
    ...
    {
      label: 'Payroll Management', toggleKey: 'payroll',
      svgIcon: '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>',
      childrenAfter: [
        {
      ...
      subgroups: [
        {
          ...
          children: [
            ...
            {
              label: 'Installments', route: '/payroll/installments',
              svgIcon: '<rect x="3" y="6" width="18" height="13" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="7" y1="15" x2="11" y2="15"/>'
            },
            {
    ...
    {
      label: 'Time Management', toggleKey: 'timeManagement',
      svgIcon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
      children: [
        {
          label: 'Attendance', route: '/time/attendance',
          svgIcon: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/>'
        }
      ]
    },
    {
      label: 'Leave Management', toggleKey: 'leave',
      ...
      children: [
        {
          ...
          svgIcon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/><line x1="9" y1="11" x2="15" y2="11"/>'
        },
        {
          label: 'Leave Adjustments', route: '/leave/adjustments',
          svgIcon: '<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/>'
        },
        {
          label: 'Leave Calendar', route: '/leave/calendar',
          svgIcon: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/><line x1="8" y1="18" x2="12" y2="18"/>'
        }
      ]
    },
    {
      ...
      subgroups: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              label: 'Approval Config', route: '/settings/approval-config',
              svgIcon: '<path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>'
            }
          ]
        },
        ...
        {
          label: 'Time', toggleKey: 'timeConfig',
          svgIcon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
          children: [
            {
              label: 'Work Shifts', route: '/config/work-shifts',
              svgIcon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>'
            },
            {
              label: 'Shift Rotations', route: '/config/shift-rotations',
              svgIcon: '<polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/>'
            }
          ]
        },
        {
          label: 'Leave', toggleKey: 'leaveConfig',
          svgIcon: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>',
          children: [
            {
              label: 'Leave Configuration', route: '/config/leave',
              svgIcon: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>'
            },
            {
              label: 'Public Holidays', route: '/config/leave/public-holidays',
              svgIcon: '<circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/>'
            }
          ]
        },
        {
