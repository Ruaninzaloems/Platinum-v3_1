  ...
  template: `
    <div class="page">
      ...
      <!-- ── Loading library ─────────────────────────────────────────────── -->
        ...
        <div class="center-state">
          <mat-spinner diameter="48"></mat-spinner>
          <p>Loading UatOvertime library…</p>
        </div>
      ...
      <!-- ── Main content ────────────────────────────────────────────────── -->
        ...
        <div class="breadcrumb-bar">
          <span class="bc-root" (click)="gotoRoot()">
            <mat-icon>home</mat-icon> UatOvertime
          </span>
...
export class UatOvertimeComponent implements OnInit {
